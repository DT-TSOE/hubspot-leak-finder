...
router.post('/', requireAuth, chatLimiter, async (req, res) => {
  ...
  try {
    ...
    const pipelineContext = buildContext(funnelData, insightsData, leadsData, null);
    const messages = [
    ...
    const response = await axios.post(
      ...
      { model: 'claude-haiku-4-5-20251001', max_tokens: 600, system: `${LA_JEFA_SYSTEM_PROMPT}\n\n${pipelineContext}`, messages },
