...
const STEPS = [
  ...
  },
  {
    ...
    characterFallback: '🤼',
    title: 'Dig Deeper',
    body: 'Pipeline, At Risk, Lead Sources, Lead Response, Revenue. Click any section to see the full picture behind your numbers.',
    cta: 'Makes sense',
    tooltipSide: 'right',
  },
  {
  ...
  },
  {
    ...
    body: "Start with the Dashboard. Everything links to where you need to go next. PipeCoach is always one click away if you get stuck.",
